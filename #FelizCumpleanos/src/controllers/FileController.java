...
public class FileController extends Controller
{
	...
	public void actionPerformed(ActionEvent event) 
	{
		...
		fileSelector.showOpenDialog(view.getContainer());
		File file = fileSelector.getSelectedFile();
		if ((file == null) || (file.getName().equals(""))) 
		{
		 JOptionPane.showMessageDialog(view.getContainer(), "Nombre de archivo inválido", "Archivo inválido", JOptionPane.ERROR_MESSAGE);
		}
